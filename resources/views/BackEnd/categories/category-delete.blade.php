                ...
                <tbody>
                    @foreach ($deletedCategories as $item)
                        <tr>
                            ...
                            <td>{{ $item->name }}</td>
                            <td><a href="category-restore/{{ $item->slug }}" class="btn btn-success btn-sm me-2" onclick="return confirm('yakin ingin mengembalikan data?')"><i class="bi bi-arrow-clockwise"></i></a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
